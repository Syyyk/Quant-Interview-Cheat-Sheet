...
Note that $n$个正态分布拼起来不一定是Gaussian vec, 但$n$个独立正态分布拼起来一定是(独立正态分布的和一定是正态分布).
...
TODO: 为什么 no dividend 情况下 Am Call 不会 early exercise?
...
TODO: 接受-拒绝采样
Perhaps Metropolis-Hastings algo
